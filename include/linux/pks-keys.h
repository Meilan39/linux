...
#define PKS_KEY_TEST		PKS_NEW_KEY(PKS_KEY_PGMAP_PROTECTION, \
					    CONFIG_PKS_TEST)
#define PKS_KEY_PAGE_CACHE	PKS_NEW_KEY(PKS_KEY_TEST, \
					    CONFIG_PCACHE_PKS)
#define PKS_KEY_MAX		PKS_NEW_KEY(PKS_KEY_PAGE_CACHE, 1)
...
#define PKS_KEY_TEST_INIT	PKS_DECLARE_INIT_VALUE(PKS_KEY_TEST, AD, \
						       CONFIG_PKS_TEST)
#define PKS_KEY_PAGE_CACHE_INIT	PKS_DECLARE_INIT_VALUE(PKS_KEY_PAGE_CACHE, WD, \
						       CONFIG_PCACHE_PKS)
